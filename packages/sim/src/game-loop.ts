import { TICK_DURATION_MS } from "@ai-arena/protocol";
import type { WorldState, MatchResult } from "@ai-arena/protocol";
...
export class GameLoop {
  ...
  /** Start the real-time loop (setTimeout-based) */
  start(): void {
    this.running = true;
    this.scheduleTick();
  }
  ...
  private scheduleTick(): void {
    ...
    // Compensate for processing time to maintain target tick rate
  ...
  /**
   * Run N ticks synchronously as fast as possible.
   * Used for testing — bypasses all timing.
   */
